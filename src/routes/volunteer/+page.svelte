<svelte:head>
	<title>Volunteer • Connect Bern </title>
</svelte:head>
...
<script>
    ...
    import { VOLUNTEER_ORGS } from "$lib/data/volunteer.data.js";
...
<section>
    <div class="header">
        ...
        <p class="page-description">
            {@html t[lang]['volunteer-description']}
        </p>
    </div>
    ...
    <div class="placesGrid">
        {#each orgs as org}
            <div class="placeCard">
                <div class="placeIcon">{org.icon}</div>
                <div class="placeContent">
                    <div>
                        <h3>{org.name}</h3>
                        <p class="placeDescription">{org.description[lang]}</p>
                    </div>
                    <div class="placeLinks">
                        <a href={org.website} class="placeLink websiteLink" target="_blank" rel="noopener noreferrer">
                            🌐 {t[lang]['volunteer-website']} →
                        </a>
                    </div>
                </div>
            </div>
