<svelte:head>
	<title>Co-Working • Connect Bern </title>
</svelte:head>
...
<script>
    ...
    import { COWORKING_PLACES } from "$lib/data/coworking.data.js";
    ...
    const places = COWORKING_PLACES;
</script>

<section>
    <div class="header">
        <h1>{t[lang]['coworking-title']}</h1>
        <p class="page-description">
            {@html t[lang]['coworking-description']}
        </p>
    </div>
    ...
    <p class="metaNote">
        {#if lang === 'de'}
            Und auf der Meta-Ebene: Connect Bern hat einen eigenen Raum für die Community. Schau dir <a href="/location">unseren eigenen Space</a> an und arbeite mit uns zusammen.
        {:else}
            And on a meta level: Connect Bern has its own space for the community. Check out <a href="/location">our own space</a> and come work together with us.
        {/if}
    </p>
</section>
